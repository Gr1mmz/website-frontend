    ...
    <Box as="section" py="4em" bg="blackAlpha.100" id="blog" fontSize="1em">
      <Container maxW="container.lg">
        ...
        <Flex mt="1.5em" gap="2em" justifyContent="space-between" flexDirection="row"
          ...
          <Box flex="1">
            <Heading as="h3" fontSize="1.2em" textAlign="center">Telegram-канал</Heading>
            <Box bg="blackAlpha.300" p="1.5em" mt="1em">
              <Text>
          ...
          <Box flex="1">
            <Heading as="h3" fontSize="1.2em" textAlign="center">Блог на сайте</Heading>
            <Box bg="blackAlpha.300" p="1.5em" mt="1em">
              <Text>
