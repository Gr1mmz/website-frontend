...
export const aboutTexts = {
  about: "Привет. Меня зовут Михаил. Мне 26 лет. Я из города Иркутск. Того самого, что рядом с Байкалом. Веб-разработкой я увлекаюсь уже более двух лет. Изначально мне было просто интересна тема создания сайтов и то, как они устроены изнутри. Позже это увлечение переросло в желание создавать какие-то продукты, будь то какое-то веб-приложение или просто красивая кнопка на сайте. Ниже вы сможете ознакомиться с моими работами и выбрать удобный способ связи со мной.",
  accordions: [
    {
      id: 1,
      header: "Образование",
